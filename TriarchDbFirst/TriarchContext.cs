...
public partial class TriarchContext : DbContext
{
    public TriarchContext()
    {
    }

    public TriarchContext(DbContextOptions<TriarchContext> options)
        : base(options)
    {
    }
    ...
    {
        optionsBuilder.UseSqlServer("Data Source=.;Initial Catalog=TriarchDbfTest;Integrated Security=True;TrustServerCertificate=True;");
