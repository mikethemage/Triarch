...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Triarch.Database.Models.CoreRuleset", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Triarch.Database.Models.Freebie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Triarch.Database.Models.Genre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Triarch.Database.Models.GenreCostPerLevel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Triarch.Database.Models.LevelableDefinition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Triarch.Database.Models.Progression", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Triarch.Database.Models.ProgressionEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Triarch.Database.Models.RPGElementDefinition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Triarch.Database.Models.RPGElementType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Triarch.Database.Models.RPGSystem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Triarch.Database.Models.VariantDefinition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RPGElementDefinitionRPGElementDefinition", b =>
                {
                    b.HasOne("Triarch.Database.Models.RPGElementDefinition", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Triarch.Database.Models.Freebie", b =>
                {
                    b.HasOne("Triarch.Database.Models.RPGElementDefinition", "FreebieElementDefinition")
                        .WithMany()
                        .HasForeignKey("FreebieElementDefinitionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Triarch.Database.Models.RPGElementDefinition", "OwnerElementDefinition")
                        .WithMany("Freebies")
            ...
            modelBuilder.Entity("Triarch.Database.Models.Genre", b =>
                {
                    b.HasOne("Triarch.Database.Models.RPGSystem", "RPGSystem")
                        .WithMany("Genres")
            ...
            modelBuilder.Entity("Triarch.Database.Models.GenreCostPerLevel", b =>
                {
                    b.HasOne("Triarch.Database.Models.Genre", "Genre")
                        .WithMany()
                        .HasForeignKey("GenreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Triarch.Database.Models.LevelableDefinition", "Levelable")
            ...
            modelBuilder.Entity("Triarch.Database.Models.LevelableDefinition", b =>
                {
                    b.HasOne("Triarch.Database.Models.Progression", "Progression")
                        .WithMany()
            ...
            modelBuilder.Entity("Triarch.Database.Models.Progression", b =>
                {
                    b.HasOne("Triarch.Database.Models.RPGSystem", null)
            ...
            modelBuilder.Entity("Triarch.Database.Models.RPGElementDefinition", b =>
                {
                    b.HasOne("Triarch.Database.Models.RPGElementType", "ElementType")
                        .WithMany()
                        .HasForeignKey("ElementTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Triarch.Database.Models.LevelableDefinition", "LevelableData")
                        .WithMany()
            ...
            modelBuilder.Entity("Triarch.Database.Models.RPGSystem", b =>
                {
                    b.HasOne("Triarch.Database.Models.CoreRuleset", "Ruleset")
                        .WithMany("RPGSystems")
            ...
            modelBuilder.Entity("Triarch.Database.Models.VariantDefinition", b =>
                {
                    b.HasOne("Triarch.Database.Models.RPGElementDefinition", "ElementDefinition")
                        .WithMany()
                        .HasForeignKey("ElementDefinitionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Triarch.Database.Models.LevelableDefinition", null)
                        .WithMany("Variants")
